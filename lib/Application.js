...
Application.prototype.confirm = function(msg, onCancel, onOK) {
}

Application.prototype.openDialog = function(title, message, field, onCancel, onOK, hideCancel) {
  this.dialog =
    { onCancel: onCancel
    , onOK:     onOK
    , field:    field
  ...
  if (hideCancel) {
    document.getElementById('dialog-btn-cancel').style.visibility = 'hidden'
  } else {
    document.getElementById('dialog-btn-cancel').style.visibility = 'visibile'
  }
...
Application.prototype.alert = function(title, msg) {
  ...
  this.openDialog('Alert', msg, false, null, null, true)
}

Application.prototype.prompt = function(title, msg, onCancel, onOK) {
  if (!onOK) {
    msg = title
    onCancel = msg
    onOK = onCancel
  ...
  this.openDialog(title, msg, onCancel, onOK)
}

Application.prototype.confirm = function(title, msg, onCancel, onOK) {
  if (!onOK) {
    msg = title
    onCancel = msg
    onOK = onCancel
  ...
  this.openDialog(title, msg, onCancel, onOK, true)
}
